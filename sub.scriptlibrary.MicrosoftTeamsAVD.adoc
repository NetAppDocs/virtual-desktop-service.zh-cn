...
summary: 脚本文档— Microsoft Teams for AVD 
keywords:  
---
= 脚本化事件文档— Microsoft Teams for AVD
...
image::scriptlibrary.activity.InstallMicrosoftTeamsAVD.png[scriptlibrary.active.InstallmicrosoftTeamsAVD]
